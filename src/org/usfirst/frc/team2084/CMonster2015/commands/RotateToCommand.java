...
public class RotateToCommand extends ParameterCommand {
    ...
    public RotateToCommand(double heading) {
        // TODO: change max speed back to 1.0 when neural network works
        this(0, 0.5);
    }
     ...
     * @param timeout the max time the command can take to complete
     * @param debug whether to print the error to the SmartDashboard
     * @param train whether to train the neural network that controls the
     *            heading
     */
    public RotateToCommand(double heading, double maxRotationSpeed,
            double timeout, boolean debug, boolean train) {
        super(timeout);
        ...
        addBooleanParameter(TRAIN_KEY, train);
    }
    ...
    protected void initialize() {
        ...
        train = getBooleanParameter(TRAIN_KEY);
        RobotMap.driveSubsystemMecanumDriveAlgorithm.setTrainingEnabled(train);
    ...
    @Override
    protected void end() {
        RobotMap.driveSubsystemMecanumDriveAlgorithm.setTrainingEnabled(false);
        if (train) {
            RobotMap.driveSubsystemMecanumDriveAlgorithm.saveTraining();
        }
