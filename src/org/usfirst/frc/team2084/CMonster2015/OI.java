...
import org.usfirst.frc.team2084.CMonster2015.commands.HeadingDataRecordingCommand;
...
public class OI {
    ...
    public JoystickButton headingRecordButton;
    ...
    public OI() {
        ...
        headingRecordButton = new JoystickButton(driveJoystick, 1);
        headingRecordButton.whileHeld(new HeadingDataRecordingCommand());
        ...
        SmartDashboard.putData("Heading Data Recording Command", new HeadingDataRecordingCommand());
