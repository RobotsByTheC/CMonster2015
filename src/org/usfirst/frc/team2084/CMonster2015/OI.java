...
public class OI {
    ...
    public OI() {
        ...
        retractToteEjectorButton = new JoystickButton(controller, 1);
        retractToteEjectorButton.whileHeld(new RetractToteEjectorCommand());
        extendToteEjectorButton = new JoystickButton(controller, 3);
        extendToteEjectorButton.whileHeld(new ExtendToteEjectorCommand());
        openToteGateButton = new JoystickButton(controller, 2);
        ...
        lowerContainerHookButton = new JoystickButton(controller, 8);
        lowerContainerHookButton.whileHeld(new LowerContainerHookCommand());
        raiseContainerHookButton = new JoystickButton(controller, 6);
        raiseContainerHookButton.whileHeld(new RaiseContainerHookCommand());
        lowerToteLifterButton = new JoystickButton(controller, 7);
        ...
        cruiseDisableButton = new JoystickButton(controller, 9);
    }
